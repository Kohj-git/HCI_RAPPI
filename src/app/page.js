...
export default function LearnSentence() {
  ...
  return (
    <div className="bg-[#ffeddf] flex flex-row justify-center w-full min-h-screen">
      <div className="bg-[#ffeddf] w-[390px] h-[844px] relative">
        {/* Header */}
        <div className="absolute top-[59px] left-6">
          <Button variant="ghost" size="icon" className="p-0 h-auto">
            <ArrowLeft className="w-[13px] h-6 text-[#ffa55d]" />
          </Button>
        </div>

        <div className="absolute top-[59px] left-[151px] font-extrabold text-[#ffa55d] text-[22px] tracking-[-0.30px] leading-5">
          Dynamite
        </div>

        <div className="absolute top-[62px] left-[221px] font-bold text-[#ffa55d] text-sm tracking-[-0.30px] leading-5">
          BTS
        </div>
